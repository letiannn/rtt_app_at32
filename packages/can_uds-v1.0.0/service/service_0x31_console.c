...
static rt_err_t vcon_init(rt_device_t dev)
{
    return RT_EOK;
}
static rt_err_t vcon_open(rt_device_t dev, rt_uint16_t oflag)
{
    return RT_EOK;
}
static rt_err_t vcon_close(rt_device_t dev)
{
    return RT_EOK;
}
